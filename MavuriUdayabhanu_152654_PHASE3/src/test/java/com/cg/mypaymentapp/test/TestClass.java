...
public class TestClass {
	...
	public void initData(){
		 ...
		 Customer cust1=new Customer("bhanu", "9030756869",new Wallet(new BigDecimal(8000)));
		 Customer cust2=new Customer("priya", "9603116338",new Wallet(new BigDecimal(6000)));
		 Customer cust3=new Customer("pavani", "7661891138",new Wallet(new BigDecimal(7000)));
				
		 data.put("9030756869", cust1);
